...
import { Github, Linkedin, Mail, ArrowRight, Code2, Terminal, Cpu, Brain } from 'lucide-react';
      ...
      <section className="border-t border-white/10 pt-24 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ProjectCard 
            ...
            description="Real-time data visualization dashboard for enterprise metrics."
          ...
          <ProjectCard 
            number="03"
            title="Orbit Chat"
            description="Encrypted real-time messaging platform with WebRTC."
            tags={['React', 'Socket.io', 'WebRTC']}
          />
          <ProjectCard 
            number="04"
            title="Synthwave Audio"
            description="Browser-based digital audio workstation and synthesizer."
            tags={['Web Audio API', 'TypeScript', 'Canvas']}
          />
          <ProjectCard 
            number="05"
            title="Quantum CMS"
            description="Headless content management system with AI generation."
            tags={['Node.js', 'PostgreSQL', 'OpenAI']}
          />
          <ProjectCard 
            number="06"
          ...
          <ProjectCard 
            ...
            description="Open-source component library for React applications."
            tags={['Storybook', 'Framer Motion', 'Tailwind']}
          />
          <ProjectCard 
            number="08"
            title="Apex Logistics"
            description="Supply chain management and route optimization software."
            tags={['Next.js', 'Google Maps API', 'Redis']}
          />
        </div>
      </section>
    </motion.div>
